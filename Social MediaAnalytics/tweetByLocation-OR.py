    ...
    def on_data(self, data):
        ...
        try:
            ...
            if "lang" in datajson and datajson["lang"] == "en" and "text" in datajson and "trump" in datajson["text"]:
                      print("Tweet collected at OR,WA,IDS" + str(created_at))
                      db.orwaidTweets.insert(datajson)
...
locOR=[-125.86, 43.45, -116.02, 50.63]
...
print("Tracking: OR Tweets")
streamer.filter(locations=locOR)
