    ...
    def on_data(self, data):
        ...
        try:
            ...
            if "lang" in datajson and datajson["lang"] == "en" and "text" in datajson and "trump" in datajson["text"]:
                      print("Tweet collected at CA,NE " + str(created_at))
                      db.caneTweets.insert(datajson)
...
#CA, NE
locCA=[-122.61, 33.21, -112.76, 41.57]
...
print("Tracking: CA Tweets")
streamer.filter(locations=locCA)
