    ...
    def on_data(self, data):
        ...
        try:
            ...
            if "lang" in datajson and datajson["lang"] == "en" and "text" in datajson and "trump" in datajson["text"]:
                      print("Tweet collected at OK,TX,LA,AR" + str(created_at))
                      db.okartxlaTweets.insert(datajson)
...
#TX,OK,LA,AR
locTX=[-104.74, 27.88, -93.54, 37.68]
...
print("Tracking: TX,OK,LA,AR Tweets")
streamer.filter(locations=locTX)
